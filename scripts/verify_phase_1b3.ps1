# Phase 1B-3 — Owner payment refund vertical slice aggregate verification
...
try {
  ...
  Write-Host '=== Step 16: leftover harness check ==='
  Assert-ReveNoHarnessObjects -Container $container

  Write-Host '=== Step 17: working tree status ==='
  ...
  Write-Host 'Phase 1B-3 aggregate verification passed.'
