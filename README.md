...
**Planning & Architecture** — Phase 0B-3B-2B-3D-2B **optional cascade rescheduling and SMS sync correction** verified. Direct apply syncs SMS; owner-triggered cascade moves later eligible lessons only. Prior phases through schedule-change review/apply (3D-2A) verified. Application UI **not** started.
...
Phase 0B-3B-2B-3D-2B까지 **애플리케이션 UI가 없습니다.** 일정 변경 검토·적용·연쇄 재배치 owner RPC, SMS 동기화, pass 시간표 교체, 결제·회차권 갱신, safe read RPC, RLS가 적용되어 있습니다. 환불 등은 미구현입니다.
