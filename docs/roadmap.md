...
Executable PostgreSQL migrations and pgTAP tests. **Current database checkpoint**: Phase 0B-3B-2B-3D-3B (tag `phase-0b3b2b3d3b-owner-sms-sent-confirmation`).
...
| 0B-3B-2B-3D-3 | Owner manual SMS sent confirmation | **Implemented (3D-3B)** |
| 0B-3B-2B-3D-3A | SMS sent confirmation specification (docs only) | **Implemented** |
| 0B-3B-2B-3D-3B | SMS sent confirmation database RPC + pgTAP | **Current** |
